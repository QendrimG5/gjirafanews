...
namespace GjirafaNewsAPI.Migrations
{
    ...
    [Migration("20260512171500_AddArticleEmbeddings2")]
    partial class AddArticleEmbeddings2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GjirafaNewsAPI.Domain.Entities.Article", b =>
                {
                    ...
                    b.HasIndex("CategoryId", "PublishedAt", "Id")
            ...
            modelBuilder.Entity("GjirafaNewsAPI.Domain.Entities.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("GjirafaNewsAPI.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
